    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="breadcrumb">
                ...
                <span></span> Contact us and Feedback us
            </div>
        </div>
    </div>                
            ...
            <div class="row">
                <div class="col-xl-8 col-lg-10 m-auto">
                    <div class="contact-from-area padding-20-row-col wow FadeInUp">
                        ...
                        @endif
                        <h3 class="mb-10 text-center">Drop Us a Line of Feedback or message</h3>
                        <p class="text-muted mb-30 text-center font-sm">contact and feedback form</p>

                        <form wire:submit.prevent="addMessage" class="contact-form-style text-center" id="contact-form">
                            <div class="row">
